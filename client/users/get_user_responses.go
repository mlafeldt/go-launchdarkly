...
func (o *GetUserOK) Error() string {
	return fmt.Sprintf("[GET /users/{projectKey}/{environmentKey}/{userKey}][%d] getUserOK  %+v", 200, o.Payload)
}
...
func (o *GetUserUnauthorized) Error() string {
	return fmt.Sprintf("[GET /users/{projectKey}/{environmentKey}/{userKey}][%d] getUserUnauthorized ", 401)
}
...
func (o *GetUserNotFound) Error() string {
	return fmt.Sprintf("[GET /users/{projectKey}/{environmentKey}/{userKey}][%d] getUserNotFound ", 404)
}
