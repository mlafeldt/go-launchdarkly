...
func (o *GetEnvironmentOK) Error() string {
	return fmt.Sprintf("[GET /projects/{projectKey}/environments/{environmentKey}][%d] getEnvironmentOK  %+v", 200, o.Payload)
}
...
func (o *GetEnvironmentUnauthorized) Error() string {
	return fmt.Sprintf("[GET /projects/{projectKey}/environments/{environmentKey}][%d] getEnvironmentUnauthorized ", 401)
}
...
func (o *GetEnvironmentNotFound) Error() string {
	return fmt.Sprintf("[GET /projects/{projectKey}/environments/{environmentKey}][%d] getEnvironmentNotFound ", 404)
}
