...
// WithResourceID adds the resourceID to the get webhook params
func (o *GetWebhookParams) WithResourceID(resourceID string) *GetWebhookParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the get webhook params
func (o *GetWebhookParams) SetResourceID(resourceID string) {
