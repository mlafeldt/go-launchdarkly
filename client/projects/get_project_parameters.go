...
// WithProjectKey adds the projectKey to the get project params
func (o *GetProjectParams) WithProjectKey(projectKey string) *GetProjectParams {
	o.SetProjectKey(projectKey)
	return o
}

// SetProjectKey adds the projectKey to the get project params
func (o *GetProjectParams) SetProjectKey(projectKey string) {
