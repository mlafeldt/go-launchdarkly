...
// WithProjectKey adds the projectKey to the delete project params
func (o *DeleteProjectParams) WithProjectKey(projectKey string) *DeleteProjectParams {
	o.SetProjectKey(projectKey)
	return o
}

// SetProjectKey adds the projectKey to the delete project params
func (o *DeleteProjectParams) SetProjectKey(projectKey string) {
